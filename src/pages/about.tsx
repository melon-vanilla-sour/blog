function HomePage() {
  return (
    <div className="max-w-lg mx-auto mt-4">
      <h1 className="display-heading text-3xl sm:text-4xl mb-6">About</h1>
      <div className="space-y-2 text-ink-5 mb-8">
      ...
      <div className="border-t border-ink-2 pt-6 mb-8">
      ...
      <div className="border-t border-ink-2 pt-6">
        <p className="text-sm text-ink-4 mb-4">Languages I'm using</p>
