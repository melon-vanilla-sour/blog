function HomePage() {
  return (
    <div className="max-w-lg mx-auto mt-8">
      <div className="border border-ctp-surface1 p-6">
        <div className="text-xs text-ctp-overlay0 mb-4">about.txt</div>
        <div className="space-y-2 text-sm text-ctp-subtext1 mb-6">
          <p>Hi I'm a Software Engineer</p>
          <p>Email: <span className="text-ctp-sapphire">melonvanillasour[at]gmail.com</span></p>
          <p>Twitter: <span className="text-ctp-sapphire">[at]melon_creamsour</span></p>
        </div>
        <div className="border-t border-ctp-surface1 pt-4 mb-4">
        ...
        <div className="border-t border-ctp-surface1 pt-4">
          <p className="text-xs text-ctp-overlay0 mb-3">Languages I'm using:</p>
          <div className="grid grid-cols-3 gap-4">
            {/* TypeScript */}
            <div className="flex flex-col items-center gap-1">
              <svg viewBox="0 0 128 128" className="w-10 h-10 text-ctp-subtext0 fill-current">
              ...
              <span className="text-xs text-ctp-overlay0">TS</span>
            </div>
            {/* Ruby */}
            <div className="flex flex-col items-center gap-1">
              <svg viewBox="0 0 128 128" className="w-10 h-10 text-ctp-subtext0 fill-current">
              ...
              <span className="text-xs text-ctp-overlay0">Ruby</span>
            </div>
            {/* PHP */}
            <div className="flex flex-col items-center gap-1">
              <svg viewBox="0 0 128 128" className="w-10 h-10 text-ctp-subtext0 fill-current">
              ...
              <span className="text-xs text-ctp-overlay0">PHP</span>
            </div>
          </div>
        </div>
      </div>
