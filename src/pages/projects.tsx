...
function Projects() {
  return (
    <Grid my={8} templateColumns={{ base: 'repeat(1, 1fr)', sm: 'repeat(2, 1fr)' }} gap={6}>
      ...
      <MediumCard link='/post/nextjs-contentful-blog' imgSrc='projects/blog-thumbnail.png' name='Blog' description='A static generated blog' stack={['Next.js', 'Chakra UI', 'Contentful', 'Vercel']}></MediumCard>
    </Grid>
  )
}
